...
{/if}
	...
	<script src="templates/wowhead/js/locale_{$language}7.js" type="text/javascript"></script>

	<script src="templates/wowhead/js/global10.js" type="text/javascript"></script>
