...
{if $page.Mapper}
	<script src="templates/wowhead/js/Mapper.js?v=20" type="text/javascript"></script>
...
{if (isset($npc) || isset($item) || isset($zone) || isset($quest))}
   ...
   <script src="/templates/topwow/js/custom.js?v=20"></script>
{/if}
...
{if $page.Talent}
	...
	<script src="templates/wowhead/js/talent.1.js?v=3"></script>
	{/if}
