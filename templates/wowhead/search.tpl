...
var myTabs = new Tabs({ldelim}parent: getElement('tabs-generic'){rdelim});
...
{if $found.factions}{include	file='bricks/factions_table.tpl'	id='factions'	name='factions'			tabsid='myTabs' data=$found.factions}{/if}
myTabs.flush();
</script>
		<div class="clear"></div>
	{else}
