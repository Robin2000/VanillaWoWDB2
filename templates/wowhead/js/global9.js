...
/*class, subclass, type, bond, quality, nature, resistance, minLvl*/
function filterItem(type,val) {	
	switch(type){
		case 'bond':return filterQuery(3,type,val);
		case 'quality':return filterQuery(4,type,val);
		case 'nature':return filterQuery(5,type,val);
		case 'resistance':return filterQuery(6,type,val);
		case 'minLvl':return filterQuery(7,type,val);
	}
}
...
function filterNpcs(type,val) {	
	switch(type){
		...
		case 'npcFlag':return filterQuery(7,type,val);
