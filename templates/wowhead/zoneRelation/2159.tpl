...
level_minlevel_minlevel_minlevel_min
new Listview({template:'npc',id:'npcs',name:LANG.tab_npcs,tabs:tabsRelated,parent:'listview-generic',extraCols:[],hiddenCols:[],sort:[ 'name'],data:[{name:'奥妮克希亚',name_en:"Onyxia",name_en_num:0,minlevel:63,level_max:63,location:["2159"],type:2,classification:3,react:[-1,-1],id:10184},{name:'奥妮克希亚守卫',name_en:"Onyxian Warder",name_en_num:0,minlevel:60,level_max:63,location:["2159"],type:2,classification:1,react:[-1,-1],id:12129},{name:'奥妮克希亚幼龙',name_en:"Onyxian Whelp",name_en_num:0,minlevel:56,level_max:57,location:[],type:2,classification:1,react:[-1,-1],id:11262},{name:'修理机器人74A型',name_en:"Field Repair Bot 74A",name_en_num:0,minlevel:50,level_max:50,location:[],type:9,classification:0,react:[1,1],id:14337}]});
...
new Listview({template:'npc',id:'bosses',name:LANG.tab_bosses,tabs:tabsRelated,parent:'listview-generic',extraCols:[],hiddenCols:[],sort:[ 'name'],data:[{name:'奥妮克希亚',name_en:"Onyxia",name_en_num:0,minlevel:63,level_max:63,location:["2159"],type:2,classification:3,react:[-1,-1],id:10184}]});
