...
switch($_SESSION['locale'])
{
	...
	mass_define(array(
		// quest
		'LOCALE_REQUIREMENTS'	=>	'需求Requirements',
		'LOCALE_QUEST_FLAGS_STAY_ALIVE'        => '需要活着Requires to stay alive',
		'LOCALE_QUEST_FLAGS_PARTY_ACCEPT'      => '建议所有队伍成员Suggested to all party members',
		'LOCALE_QUEST_FLAGS_EXPLORATION'       => '勘探相关Exploration related',
		'LOCALE_QUEST_FLAGS_SHARABLE'          => '可共享Sharable',
		'LOCALE_QUEST_FLAGS_EPIC'              => '史诗Epic',
		'LOCALE_QUEST_FLAGS_RAID'              => '多人团Raid',
		'LOCALE_QUEST_FLAGS_TBC'               => '需要燃烧的远征The Burning Crusade required',
		'LOCALE_QUEST_FLAGS_UNK2'              => '使用额外装备Additional items used',
		'LOCALE_QUEST_FLAGS_HIDDEN_REWARDS'    => '完成时显示奖励Rewards are shown only at completion',
		'LOCALE_QUEST_FLAGS_AUTO_REWARDED'     => '自动完成和奖励Automatically complete and rewarded',
		'LOCALE_QUEST_FLAGS_TBC_RACES'         => '血精灵和德莱尼的位置Blood Elves/Draenei locations',
		'LOCALE_QUEST_FLAGS_DAILY'             => '每日Daily',
		'LOCALE_QUEST_FLAGS_UNK5'              => '玩家对玩家PvP',
		'LOCALE_QUEST_SPECIALFLAGS_REPEATABLE' => '可重复Repeatable',
		'LOCALE_QUEST_SPECIALFLAGS_SCRIPTED'   => '仅通过脚本/事件完成Completed only by script/event',
		'LOCALE_QUEST_HAS_POI'                 => '有兴趣点Has points of interest',
		'LOCALE_QUEST_HAS_START_SCRIPT'        => '有启动脚本Has start script',
		'LOCALE_QUEST_HAS_COMPLETE_SCRIPT'     => '有结束脚本Has end script',
		'LOCALE_QUEST_TYPE_GROUP'              => '队伍Group',
		'LOCALE_QUEST_TYPE_LIFE'               => '生活Life',
		'LOCALE_QUEST_TYPE_PVP'                => '玩家对玩家PvP',
		'LOCALE_QUEST_TYPE_RAID'               => '多人团Raid',
		'LOCALE_QUEST_TYPE_DUNGEON'            => '地下城Dungeon',
		'LOCALE_QUEST_TYPE_WORLD_EVENT'        => '世界事件World Event',
		'LOCALE_QUEST_TYPE_LEGENDARY'          => '传说Legendary',
		'LOCALE_QUEST_TYPE_ESCORT'             => '护送Escort',
		'LOCALE_QUEST_TYPE_HEROIC'             => '英雄Heroic',
		'LOCALE_QUEST_TYPE_RAID10'             => '多人团Raid (10)',
		'LOCALE_QUEST_TYPE_RAID25'             => '多人团Raid (25)',
		// classes
		'LOCALE_WARRIOR'		=>	'战士Warrior',
		'LOCALE_PALADIN'		=>	'圣骑士Paladin',
		'LOCALE_HUNTER'			=>	'猎人Hunter',
		'LOCALE_ROGUE'			=>	'盗贼Rogue',
		'LOCALE_PRIEST'			=>	'牧师Priest',
		'LOCALE_DEATH_KNIGHT'	=>	'死亡骑士Death Knight',
		'LOCALE_SHAMAN'			=>	'萨满Shaman',
		'LOCALE_MAGE'			=>	'法师Mage',
		'LOCALE_WARLOCK'		=>	'术士Warlock',
		'LOCALE_DRUID'			=>	'德鲁伊Druid',
		// races
		'LOCALE_HUMAN'			=>	'人类Human',
		'LOCALE_ORC'			=>	'牛头人Orc',
		'LOCALE_DWARF'			=>	'矮人Dwarf',
		'LOCALE_NIGHT_ELF'		=>	'暗夜精灵Night Elf',
		'LOCALE_UNDEAD'			=>	'不死族Undead',
		'LOCALE_TAUREN'			=>	'扭头人Tauren',
		'LOCALE_GNOME'			=>	'侏儒Gnome',
		'LOCALE_TROLL'			=>	'巨魔Troll',
		'LOCALE_BLOOD_ELF'		=>	'血精灵Blood Elf',
		'LOCALE_DRAENEI'		=>	'德莱尼Draenei',
		// side
		'LOCALE_BOTH_FACTIONS'	=>	'双方Both',
		'LOCALE_HORDE'			=>	'部落Horde',
		'LOCALE_ALLIANCE'		=>	'联盟Alliance',
		// reputation
		'LOCALE_NEUTRAL'	=>	'中立Neutral',
		'LOCALE_FRIENDLY'	=>	'友好Friendly',
		'LOCALE_HONORED'	=>	'尊敬Honored',
		'LOCALE_REVERED'	=>	'崇敬Revered',
		'LOCALE_EXALTED'	=>	'崇拜Exalted',
		// resistances
		'LOCALE_FIRE_RESISTANCE'	=>	'火焰抗性Fire Resistance',
		'LOCALE_FROST_RESISTANCE'	=>	'冰霜抗性Frost Resistance',
		'LOCALE_ARCANE_RESISTANCE'	=>	'奥术抗性Arcane Resistance',
		'LOCALE_SHADOW_RESISTANCE'	=>	'暗影抗性Shadow Resistance',
		'LOCALE_NATURE_RESISTANCE'	=>	'自然抗性Nature Resistance',
		'LOCALE_HOLY_RESISTANCE'	=>	'不存在抗性RESISTANCE DOES NOT EXIST',
		// binds
		'LOCALE_BIND_PICKUP'		=>	'拾取绑定Binds when picked up',
		'LOCALE_BIND_EQUIP'			=>	'装备绑定Binds when equipped',
		'LOCALE_BIND_USE'			=>	'使用绑定Binds when used',
		'LOCALE_BIND_SOULBOUND'		=>	'灵魂绑定Soulbound',
		'LOCALE_BIND_QUEST_ITEM'	=>	'任务物品Quest Item',
		// bags
		'LOCALE_BAG'			=>	'背包Bag',
		'LOCALE_BAG_QUIVER'		=>	'箭袋Quiver',
		'LOCALE_BAG_AMMO'		=>	'弹药袋Ammo Pouch',
		'LOCALE_BAG_SOUL'		=>	'灵魂袋Soul Bag',
		'LOCALE_BAG_LEATHER'	=>	'制皮袋Leatherworking Bag',
		'LOCALE_BAG_HERB'		=>	'采药袋Herb Bag',
		'LOCALE_BAG_ENCHANT'	=>	'附魔袋Enchanting bag',
		'LOCALE_BAG_ENGINEER'	=>	'工程包Engineering Bag',
		'LOCALE_BAG_GEM'		=>	'宝石袋Gem Bag',
		'LOCALE_BAG_MINING'		=>	'采矿包Mining Bag',
		// equip slots
		'LOCALE_EQUIP_HEAD'				=>	'头Head',
		'LOCALE_EQUIP_NECK'				=>	'脖子Neck',
		'LOCALE_EQUIP_SHOULDER'			=>	'肩膀Shoulder',
		'LOCALE_EQUIP_SHIRT'			=>	'衬衫Shirt',
		'LOCALE_EQUIP_CHEST'			=>	'胸甲Chest',
		'LOCALE_EQUIP_WAIST'			=>	'腰Waist',
		'LOCALE_EQUIP_LEGS'				=>	'腿Legs',
		'LOCALE_EQUIP_FEET'				=>	'脚Feet',
		'LOCALE_EQUIP_WRIST'			=>	'腕Wrist',
		'LOCALE_EQUIP_HANDS'			=>	'手Hands',
		'LOCALE_EQUIP_FINGER'			=>	'手指Finger',
		'LOCALE_EQUIP_TRINKET'			=>	'配饰Trinket',
		'LOCALE_EQUIP_ONEHAND'			=>	'单手One-hand',
		'LOCALE_EQUIP_OFFHAND'			=>	'副手Off Hand',
		'LOCALE_EQUIP_RANGED'			=>	'远程Ranged',
		'LOCALE_EQUIP_BACK'				=>	'背Back',
		'LOCALE_EQUIP_TWOHAND'			=>	'双手Two-hand',
		'LOCALE_EQUIP_UNK0'				=>	'',
		'LOCALE_EQUIP_TABARD'			=>	'战袍徽章Tabard',
		'LOCALE_EQUIP_MAINHAND'			=>	'主手Main Hand',
		'LOCALE_EQUIP_CHEST2'			=>	'胸Chest',
		'LOCALE_EQUIP_OFFHAND2'			=>	'副手Off Hand',
		'LOCALE_EQUIP_HELDINOFFHAND'	=>	'副手物品Held In Off-Hand',
		'LOCALE_EQUIP_PROJECTILE'		=>	'射弹Projectile',
		'LOCALE_EQUIP_THROWN'			=>	'抛掷物Thrown',
		'LOCALE_EQUIP_RANGED2'			=>	'远程Ranged',
		'LOCALE_EQUIP_UNK1'				=>	'',
		'LOCALE_EQUIP_RELIC'			=>	'遗迹Relic',
		// armor type
		'LOCALE_ARMOR_CLOTH'	=>	'布甲Cloth',
		'LOCALE_ARMOR_LEATHER'	=>	'皮夹Leather',
		'LOCALE_ARMOR_MAIL'		=>	'链甲Mail',
		'LOCALE_ARMOR_PLATE'	=>	'板甲Plate',
		'LOCALE_ARMOR_BUCKLER'	=>	'',
		'LOCALE_ARMOR_SHIELD'	=>	'盾牌Shield',
		'LOCALE_ARMOR_LIBRAM'	=>	'圣契Libram',
		'LOCALE_ARMOR_IDOL'		=>	'幻像Idol',
		'LOCALE_ARMOR_TOTEM'	=>	'图腾Totem',
		// weapon type
		'LOCALE_WEAPON_AXE1H'		=>	'斧Axe',
		'LOCALE_WEAPON_AXE2H'		=>	'斧Axe',
		'LOCALE_WEAPON_BOW'			=>	'弓Bow',
		'LOCALE_WEAPON_GUN'			=>	'枪Gun',
		'LOCALE_WEAPON_MACE1H'		=>	'权杖Mace',
		'LOCALE_WEAPON_MACE2H'		=>	'权杖Mace',
		'LOCALE_WEAPON_POLEARM'		=>	'长柄武器Polearm',
		'LOCALE_WEAPON_SWORD1H'		=>	'剑Sword',
		'LOCALE_WEAPON_SWORD2H'		=>	'剑Sword',
		'LOCALE_WEAPON_OBSOLETE'	=>	'',
		'LOCALE_WEAPON_STAFF'		=>	'法杖Staff',
		'LOCALE_WEAPON_EXOTIC'		=>	'',
		'LOCALE_WEAPON_EXOTIC2'		=>	'',
		'LOCALE_WEAPON_FIST'		=>	'初始武器Fist Weapon',
		'LOCALE_WEAPON_MISC'		=>	'杂合Miscellaneous',
		'LOCALE_WEAPON_DAGGER'		=>	'匕首Dagger',
		'LOCALE_WEAPON_THROWN'		=>	'投掷Thrown',
		'LOCALE_WEAPON_SPEAR'		=>	'',
		'LOCALE_WEAPON_CROSSBOW'	=>	'十字弓Crossbow',
		'LOCALE_WEAPON_WAND'		=>	'魔杖Wand',
		'LOCALE_WEAPON_FISHINGPOLE'	=>	'鱼竿Fishing Pole',
		// projectile type
		'LOCALE_PROJECTILE_WAND'	=>	'',
		'LOCALE_PROJECTILE_BOLT'	=>	'',
		'LOCALE_PROJECTILE_ARROW'	=>	'箭Arrow',
		'LOCALE_PROJECTILE_BULLET'	=>	'子弹Bullet',
		'LOCALE_PROJECTILE_THROWN'	=>	'',
		// damage
		'LOCALE_DAMAGE_PRE'		=>	' ',
		'LOCALE_DAMAGE_POST'	=>	'单次伤害Damage',
		'LOCALE_DAMAGE_HOLY'	=>	'神圣伤害Holy',
		'LOCALE_DAMAGE_FIRE'	=>	'火焰伤害Fire',
		'LOCALE_DAMAGE_FROST'	=>	'冰霜伤害Frost',
		'LOCALE_DAMAGE_ARCANE'	=>	'奥术伤害Arcane',
		'LOCALE_DAMAGE_SHADOW'	=>	'暗影伤害Shadow',
		'LOCALE_DAMAGE_NATURE'	=>	'自然伤害Nature',
		// stats
		'LOCALE_STAT_STRENGTH'	=>	' 力量Strength',
		'LOCALE_STAT_STAMINA'	=>	' 耐力Stamina',
		'LOCALE_STAT_INTELLECT'	=>	' 智力Intellect',
		'LOCALE_STAT_SPIRIT'	=>	' 精神Spirit',
		'LOCALE_STAT_AGILITY'	=>	' 敏捷Agility',
		// green bonuses
		'LOCALE_GBONUS_DEFENCE'				=>	'提升防御率%d。Increases defense rating by %d.',
		'LOCALE_GBONUS_DODGE'				=>	'提升闪躲率%d。Increases your dodge rating by %d.',
		'LOCALE_GBONUS_PARRY'				=>	'提升格挡率%d。Increases your parry rating by %d.',
		'LOCALE_GBONUS_SHIELDBLOCK'			=>	'提升盾牌阻挡率%d。Increases your shield block rating by %d.',
		'LOCALE_GBONUS_SPELLHIT_RATING'		=>	'提升法术命中率%d。Improves spell hit rating by %d.',
		'LOCALE_GBONUS_MELEECRIT_RATING'	=>	'提升近战爆击率%d。Improves melee critical strike rating by %d.',
		'LOCALE_GBONUS_RANGEDCRIT_RATING'	=>	'提升远程爆击率%d。Improves ranged critical strike rating by %d.',
		'LOCALE_GBONUS_SPELLCRIT_RATING'	=>	'提升法术爆击率%d。Improves spell critical strike rating by %d.',
		'LOCALE_GBONUS_SPELLHASTE_RATING'	=>	'提升施法速度%d。Improves spell haste rating by %d.',
		'LOCALE_GBONUS_HIT_RATING'			=>	'提升命中率%d。Increases your hit rating by %d.',
		'LOCALE_GBONUS_CRIT_RATING'			=>	'提升爆击率%d。Increases your critical strike rating by %d.',
		'LOCALE_GBONUS_RESILIENCE_RATING'	=>	'提升恢复率%d。Improves your resilience rating by %d.',
		'LOCALE_GBONUS_HASTE_RATING'		=>	'提升加速率%d。Improves haste rating by %d.',
		'LOCALE_GBONUS_EXPERTISE_RATING'	=>	'提升熟练率%d。Increases your expertise rating by %d.',
		'LOCALE_GBONUS_RESTOREMANA'			=>	'5秒回蓝率%d。Restores %d mana per 5 sec.',
		'LOCALE_GBONUS_ATTACKPOWER'			=>	'提升攻击能%d。Increases attack power by %d.',
		'LOCALE_GBONUS_ARMORPENETRATION'	=>	'提升你的护甲穿透率%d。Increases your armor penetration rating by %d.',
		'LOCALE_GBONUS_SPELLPOWER'			=>	'提升法术能%d。Improves spell power by %d.',
		'LOCALE_GBONUS_UNKNOWN'				=>	'未知奖励%d。Unknown Bonus #%d',
		'LOCALE_GBONUS_CHANCEONHIT'			=>	'命中机会:Chance on hit: ',
		'LOCALE_GBONUS_EQUIP'				=>	'装备Equip: ',
		'LOCALE_GBONUS_USE'					=>	'使用Use: ',
		'LOCALE_COMBAT_RATING'				=>	'%s&nbsp;@&nbsp;L%d',
		// sockets
		'LOCALE_SOCKET_META'	=>	'金属槽Meta Socket',
		'LOCALE_SOCKET_RED'		=>	'红色槽Red Socket',
		'LOCALE_SOCKET_YELLOW'	=>	'黄色槽Yellow Socket',
		'LOCALE_SOCKET_BLUE'	=>	'蓝色槽Blue Socket',
		'LOCALE_SOCKET_BONUS'	=>	'插槽奖励Socket Bonus',
		
		// misc
		'LOCALE_SPEED'			=>	'速度Speed',
		'LOCALE_UNIQUE'			=>	'唯一Unique',
		'LOCALE_START_QUEST'	=>	'该物品开始一个任务。This Item Begins a Quest',
		'LOCALE_SLOT'			=>	'位置 Slot ',
		'LOCALE_DPS'			=>	'秒伤damage per second',
		'LOCALE_DPS2'			=>	'秒伤damage per second',
		'LOCALE_DPS_ADDS'		=>	'增加Adds',
		'LOCALE_ARMOR'			=>	'装甲Armor',
		'LOCALE_BLOCK'			=>	'阻断Block',
		'LOCALE_REQUIRES'		=>	'需要Requires',
		'LOCALE_REQUIRES_LEVEL'	=>	'需要等级Requires Level',
		'LOCALE_DURABILITY'		=>	'耐用Durability',
